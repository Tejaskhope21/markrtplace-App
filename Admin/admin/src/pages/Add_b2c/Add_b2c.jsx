...
const Add_b2c = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      !formData.rating  // Ensure rating is provided
    ) {
    ...
    if (
      ...
      isNaN(Number(formData.rating)) ||  // Validate rating is a number
      formData.rating < 0 ||
      formData.rating > 5  // Ensure rating is within range
    ) {
    ...
    data.append("rating", formData.rating);  // Added rating in API request
  ...
  return (
    <div className="add-item-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>Rating:</label>
        <input type="number" name="rating" min="0" max="5" value={formData.rating} onChange={handleChange} required />
